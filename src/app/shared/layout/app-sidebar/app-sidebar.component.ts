...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      name: "Pacientes",
      subItems: [
        { name: "Cadastro", path: "/paciente/novo", },
        { name: "Consulta", path: "/paciente/lista", }
      ],
    },
    {
      ...
      // path: "/profissional",
      subItems: [
        { name: "Cadastro", path: "/profissional/novo", },
        { name: "Consulta", path: "/profissional/lista", }
      ],
    ...
    },
    {
      ...
      name: "Orçamentos",
      subItems: [
        { name: "Novo Orçamento", path: "/orcamento/novo" },
        { name: "Lista", path: "/orcamento/lista" },
      ],
    },
    {
